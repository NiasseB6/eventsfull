...
export default function Ticket({ ticketId }: { ticketId: Id<"tickets"> }) {
  ...
  return (
    <div
      className={`bg-white rounded-xl overflow-hidden shadow-xl border ${ticket.event.is_canceled ? "border-red-200" : "border-gray-100"}`}
    >
      ...
      <div className="relative">
        {imageUrl && (
          <div className="relative w-full aspect-[21/9] ">
            <Image
              ...
              fill
              className={`object-cover object-center ${ticket.event.is_canceled ? "opacity-50" : ""}`}
              priority
            />
        ...
        <div
          className={`px-6 py-4 ${imageUrl ? "absolute bottom-0 left-0 right-0" : ticket.event.is_canceled ? "bg-red-600" : "bg-blue-600"} `}
        >
          <h2
        ...
        <div className="grid grid-cols-2 gap-6">
          ...
          <div className="space-y-4">
            <div className="flex items-center text-gray-600">
              <CalendarDays
                className={`w-5 h-5 mr-3 ${ticket.event.is_canceled ? "text-red-600" : "text-blue-600"}`}
              />
              <div>
            ...
            <div className="flex items-center text-gray-600">
              ...
              />
              <div>
                <p className="text-sm text-gray-500">Vendeur du billet</p>
            ...
            <div className="flex items-center text-gray-600 break-all">
              ...
              />
              <div>
                <p className="text-sm text-gray-500">ID du proprietaire</p>
            ...
            <div className="flex items-center text-gray-600">
              ...
              <div>
                ...
                <p className="font-medium">{ticket.event.price.toFixed(2)} FCFA</p>
              </div>
            </div>
          </div>
          ...
          <div className="flex flex-col items-center justify-center border-l border-gray-200 pl-6">
            <div
              className={`bg-gray-100 p-4 rounded-lg ${ticket.event.is_canceled ? "opacity-50" : ""}`}
            >
      ...
      {/* Ticket Footer */}
      <div
        className={`${ticket.event.is_canceled ? "bg-red-50" : "bg-gray-50"} px-6 py-4 flex justify-between items-center`}
      >
        <span className="text-sm text-gray-500">
          Date d'achat: {new Date(ticket.purchasedAt).toLocaleString()}
        </span>
        <span
          className={`text-sm font-medium ${ticket.event.is_canceled ? "text-red-600" : "text-blue-600"}`}
        >
