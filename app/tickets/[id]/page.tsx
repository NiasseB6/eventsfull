    ...
    <div className="min-h-screen bg-gray-50 py-12 px-4 sm:px-6 lg:px-8">
      <div className="max-w-3xl mx-auto">
        <div className="mb-8 space-y-8">
          ...
          {/* Event Info Summary */}
          <div
            className={`bg-white p-6 rounded-lg shadow-sm border ${ticket.event.is_canceled ? "border-red-200" : "border-gray-100"}`}
          >
        ...
        >
          ...
          <p
            className={`mt-1 text-sm ${
              ticket.event.is_canceled ? "text-red-700" : "text-blue-700"
            }`}
          >
            {ticket.event.is_canceled
